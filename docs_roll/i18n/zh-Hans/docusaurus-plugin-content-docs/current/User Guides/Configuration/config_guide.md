...
有关 RLVR/Agentic Pipeline配置和Reward设置的更多详细信息，还可以参阅 [RLVR Pipeline Start](../../User%20Guides/Pipeline/rlvr_pipeline_start.md) 和 [Agentic Pipeline Start](../../User%20Guides/Pipeline/agentic_pipeline_start.md)

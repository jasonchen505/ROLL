...
配置系统描述参见[config_system](../Configuration/config_system.md)
#### 配置文件结构与组织
...
* **已训练模型** – 检查点保存在 `checkpoint_config`中，具体参考文档[checkpoint_and_resume](../Advanced%20Features/checkpoint_and_resume.md)。
